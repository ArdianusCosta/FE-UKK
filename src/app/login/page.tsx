...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error(error.response?.data?.message || "Login gagal. Silakan cek kembali username dan password Anda.")
        } finally {
            setIsLoading(false)
        }
    }
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="/forgot-password" title="Lupa password?" className="text-xs text-primary hover:underline">Lupa password?</Link>
                            </div>
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="pl-10 pr-10 glass border-white/10 focus-visible:ring-primary/30 h-11"
                                />
                                <button
                                    type="button"
                    ...
                    <CardFooter className="flex flex-col gap-5 pt-2">
                        ...
                        <div className="relative w-full">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-[#0a0e1a]/80 backdrop-blur-sm px-2 text-muted-foreground">
                                    atau masuk dengan
                                </span>
                            </div>
                        </div>
                        ...
                        >
                            <svg className="h-5 w-5" viewBox="0 0 24 24">
                                ...
                                />
                                <path
                                    d="M12 5.38c1.62 0 3.06.56 4.21 1.66l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 6.13l3.66 2.84c.87-2.6 3.3-4.53 12-4.53z"
                                    fill="#EA4335"
                                />
                            </svg>
                            Google
